...
- July 23, 2025. **TECNICO FAUNISTICO DEMO SYSTEM**: Complete implementation of fauna technician demo functionality
  - **Landing Page Demo**: Added third demo card for "SONO UN TECNICO FAUNISTICO" with purple gradient and scientific icon
  - **Demo Authentication**: Added tecnico-faunistico account to DEMO_ACCOUNTS with BIOLOGO role and demo credentials
  - **Backend Support**: Enhanced demo system to support tecnico-faunistico type with /app?demo=tecnico-faunistico URL parameter
  - **Demo Features**: Added scientific features list including GPS observations, biometric data, population analysis
  - **Visual Integration**: Updated demo layout from 2-column to 3-column grid for hunter/admin/tecnico-faunistico options
